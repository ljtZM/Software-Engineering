...
import Login from './pages/Login';
import DataCenter from './pages/DataCenter'; // 导入新创建的数据中心组件
  ...
  {['主要信息', '水下系统', '数据中心', '智能中心'].map((item, index) => (
    <button
      ...
      onClick={() => {
        ...
        if (index === 2) navigate('/data-center'); // 添加数据中心的导航
      }}
      style={{
    ...
    >
      ...
      <div style={{
        ...
        ...((index === 0 && window.location.pathname === '/login') || 
           (index === 2 && window.location.pathname === '/data-center') 
          ? { transform: 'scaleX(1)' } : {})
      }}/>
